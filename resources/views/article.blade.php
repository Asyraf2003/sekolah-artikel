      ...
      <div class="grid grid-cols-12 gap-6">
        ...
        @unless($isSearch)
          <aside class="hidden lg:block col-span-12 lg:col-span-2 space-y-6">
            @php $tagsPopular = \App\Models\Tag::popularPublished()->limit(16)->get(); @endphp
            <div class="rounded-2xl border border-gray-200 dark:border-gray-800 p-4">
              ...
              <div class="flex flex-wrap gap-2">
                @foreach($tagsPopular as $t)
                  <a href="{{ route('articles.index', ['tag'=>$t->slug]) }}" class="text-xs rounded-full bg-gray-100 dark:bg-gray-900 px-3 py-1 border border-gray-200 dark:border-gray-800 hover:bg-gray-200 dark:hover:bg-gray-800">#{{ $t->name }}<span class="text-xs text-gray-400">({{ $t->published_articles_count }})</span></a>
                @endforeach
              </div>
            </div>
            <div class="rounded-2xl border border-gray-200 dark:border-gray-800 p-4">
