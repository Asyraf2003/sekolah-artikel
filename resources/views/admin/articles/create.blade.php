                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="card">
                            <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                                ...
                                <div class="small text-muted">Header, quote, bold/italic/underline/strike, warna, list, link, image.</div>
                            </div>

                            <div class="card-body">

                                <div id="quillEditor" class="bg-white border rounded"></div>

                                <input type="hidden" name="content_delta_id" id="contentDeltaId" value="{{ old('content_delta_id') }}">
                                <input type="hidden" name="content_html_id"  id="contentHtmlId"  value="{{ old('content_html_id') }}">

                                <input type="hidden" name="content_delta_en" id="contentDeltaEn" value="{{ old('content_delta_en') }}">
                                <input type="hidden" name="content_html_en"  id="contentHtmlEn"  value="{{ old('content_html_en') }}">

                                <input type="hidden" name="content_delta_ar" id="contentDeltaAr" value="{{ old('content_delta_ar') }}">
                                <input type="hidden" name="content_html_ar"  id="contentHtmlAr"  value="{{ old('content_html_ar') }}">
                                ...
                                <div class="form-text mt-2">
                                    Untuk gambar: nanti kita bikin upload endpoint biar ga pakai base64.
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
(function () {
    // ===== Helpers UI (cover, slug preview, publish time, tags) =====
    ...
    // ===== Quill (1 instance) + multi-language content (ID/EN/AR) =====
    ...
    // validasi element penting ada
    if (!elDelta.id || !elHtml.id || !document.getElementById('quillEditor')) {
    ...
    function loadLang(lang) {
        ...
        if (raw.trim() !== '') {
            try {
                ...
                // fallback kosong kalau delta rusak
            }
        }
        quill.setText('');
    }
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // load konten awal untuk ID dari old()
        loadLang(activeLang);

        // switching tabs: simpan lama -> load baru
        ...
        // submit: simpan bahasa aktif + tags
