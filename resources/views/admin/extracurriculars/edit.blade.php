<x-page.admin>
    @php
        $backUrl = route('admin.extracurriculars.index', request()->query());
        $isPublishedChecked = (bool) old('is_published', $extracurricular->is_published);
        $title = $extracurricular->name_id ?: ($extracurricular->name_en ?: ($extracurricular->name_ar ?: '—'));
        $isTrashed = method_exists($extracurricular, 'trashed') && $extracurricular->trashed();
    @endphp
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-start gap-2">
            <div>
                ...
                <p class="text-muted mb-0">
                    Perbarui: <span class="fw-semibold">{{ $title }}</span>
                    <span class="text-muted">#{{ $extracurricular->id }}</span>
                    @if($isTrashed)
            ...
            <div class="d-flex gap-2 flex-wrap">
                ...
                @if($isTrashed && \Illuminate\Support\Facades\Route::has('admin.extracurriculars.restore'))
                    <form action="{{ route('admin.extracurriculars.restore', $extracurricular->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('PATCH')
                ...
                <button form="ekstraEditForm" type="submit" class="btn btn-primary">
    ...
    <div class="page-content">
        <section class="section">
            ...
            <form id="ekstraEditForm" method="POST" action="{{ route('admin.extracurriculars.update', $extracurricular->id) }}">
                @csrf
                @method('PUT')
                                    ...
                                    <div class="tab-pane fade show active" id="pane-id" role="tabpanel" aria-labelledby="tab-id">
                                        <div class="mb-0">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('name_id', $extracurricular->name_id) }}">
                                    ...
                                    <div class="tab-pane fade" id="pane-en" role="tabpanel" aria-labelledby="tab-en">
                                        <div class="mb-0">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('name_en', $extracurricular->name_en) }}">
                                    ...
                                    <div class="tab-pane fade" id="pane-ar" role="tabpanel" aria-labelledby="tab-ar">
                                        <div class="mb-0">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('name_ar', $extracurricular->name_ar) }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="small text-muted mt-3">
                                    <div class="mb-1">
                                        ...
                                        Dibuat: <strong>{{ $extracurricular->created_at?->format('d M Y H:i') ?? '—' }}</strong>
                                    </div>
                                    <div class="mb-0">
                                        <i class="bi bi-arrow-repeat me-1"></i>
                                        Update: <strong>{{ $extracurricular->updated_at?->format('d M Y H:i') ?? '—' }}</strong>
                                    </div>
                                </div>
                    ...
                    <div class="card border-danger mt-3">
                        ...
                        <div class="card-body d-flex flex-wrap justify-content-between align-items-center gap-2">
                            <div class="text-muted">
                                @if(!$isTrashed)
                                    Hapus item ini (soft delete).
                                @else
                                    Item ini sudah dihapus (soft delete).
                                @endif
                            </div>
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                ...
                                @else
                                    @if(\Illuminate\Support\Facades\Route::has('admin.extracurriculars.restore'))
                                        <form action="{{ route('admin.extracurriculars.restore', $extracurricular->id) }}"
                                              method="POST"
                                              onsubmit="return confirm('Pulihkan item ini?')">
                                            @csrf
                                            @method('PATCH')
                                    ...
                                    @if(\Illuminate\Support\Facades\Route::has('admin.extracurriculars.forceDestroy'))
                                        <form action="{{ route('admin.extracurriculars.forceDestroy', $extracurricular->id) }}"
                                              method="POST"
                                              onsubmit="return confirm('Hapus permanen item ini? Ini tidak bisa dibatalkan.')">
                                            @csrf
                                            @method('DELETE')
